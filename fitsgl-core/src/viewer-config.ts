...
import { isColormapName, isStretchMode } from './renderer/index.js';
import type {
  ColormapLUT,
  ColormapName,
  RenderSource,
...
/** The initial view: one band (optionally colormapped), or three bands as R/G/B. */
...
export function renderSourceForView(
  ...
  return { kind: 'rgb', r: need(view.r), g: need(view.g), b: need(view.b) };
}
